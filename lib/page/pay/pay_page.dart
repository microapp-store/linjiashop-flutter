          ...
          Container(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  _myListTile('应付金额','¥'+widget.totalPrice,ThemeTextStyle.detailStylePrice),
                  _myListTileIcon(Icon(MyIcons.weixinpay, size: 30,color:Colors.green,),0),
                  ThemeView.divider(),
                  _myListTileIcon(Icon(MyIcons.zhifubpay, size: 40,color:Colors.blue),1),
                ],
              )
          ),
          Positioned(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: MyAppBar(
          ...
          child:CommonBackTopBar(title: "收银台",onBack:()=>Navigator.pop(context)),
        ),
        body: _getContent()
    );
  }
